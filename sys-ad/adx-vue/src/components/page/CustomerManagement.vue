    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" >
                ...
                <el-table-column prop="fullName" label="公司名称"  width="100" align="center">
                </el-table-column>
                ...
                <el-table-column prop="readonly" label="客户权限"  align="center" :formatter=formatterType>
                </el-table-column>
                <el-table-column prop="" label="用户权限"  align="center">
                  <template slot-scope="scope">
                      <img src="../../assets/u518.png"  alt="用户权限" @click="edit_quanxian(scope.$index, scope.row)">
                  </template>
                </el-table-column>
                ...
                <el-table-column label="操作"  width="300" align="center">
                    <template slot-scope="scope">
                        <el-button size="small" type="success" @click="finance_manage(scope.$index, scope.row)">财务管理</el-button>
                        <el-button size="small" type="danger" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
                        <el-button size="small" type="danger" @click="handleEdit(scope.$index, scope.row)">媒体审核</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="新建客户" :visible.sync="newVisible" width="45%" class="demo-ruleForm">
            <el-form ref="form" :model="form" :rules="rules2"  status-icon label-width="100px">
                ...
                <el-form-item label="竞价系数:">
                  <el-input v-model="form.bidDiscount" style="width:80%"></el-input>
                </el-form-item>
                <el-form-item label="扣费系数:">
                  <el-input v-model="form.payDiscount" style="width:80%"></el-input>
                </el-form-item>
        ...
        <el-dialog title="媒体审核" :visible.sync="media_Audit" width="60%">
            <el-form ref="form" :model="form"   status-icon label-width="100px">
                ...
                <el-form-item label="公司名称:">
                  <el-input v-model="form.fullName" placeholder="请输入公司名称" style="width:80%"  :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="行业类型:">
                  <el-select v-model="form.industryType"  class="handle-input">
                    <el-option
                ...
                <el-form-item label="联系电话:">
                     <el-input v-model="form.phone" placeholder="请输入联系电话" style="width:80%"></el-input>
                </el-form-item>
                <el-form-item label="联系地址:">
                ...
                <div class="splice"></div>
                 <el-table :data="media" border style="width: 100%" ref="multipleTable">
                    ...
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button size="small" type="success" @click="commit_Audit(scope.$index, scope.row)">提交审核</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-form>
...
import { relationAdd } from "@/api/Api.js";
...
// 提交审核
    ...
    // },
      ...
      finance_manage(index,row){
          this.$router.push({path:'/moneymanagement/customer',query:{id:row.id,fullName:row.fullName}})
      },
