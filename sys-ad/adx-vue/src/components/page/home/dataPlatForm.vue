...
<script>
import { consumerdataall } from "@/api/Api.js";
...
export default {
  ...
  data: () => ({
    ...
    xAxis:[],
    item: [],
    titleList:['请求量','填充量','展现量','点击量','填充率%','展现率%','点击率%','成本','CPM','CPC'],
  ...
  methods: {
    ...
    RequestTime() {
        ...
        consumerdataall(params).then(res=>{
          let data = res.data;
        ...
        var reqs=[];var bid=[];var exp=[];var clk=[];var bid_rate=[];var exp_rate=[];var clk_rate=[];var cost=[];var cpm=[];var cpc=[];
