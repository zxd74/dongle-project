    ...
    <div class="table">
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable">
                ...
                <el-table-column prop="name" label="投放名称" width="200" align="center">
                </el-table-column>
                <el-table-column prop="name" label="计费/底价" align="center">
                </el-table-column>
                <el-table-column prop="name" label="广告订单" align="center">
                </el-table-column>
                <el-table-column prop="name" label="广告客户" align="center">
                </el-table-column>
        ...
        <el-dialog title="新建投放" :visible.sync="newVisible" width="65%">
          <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <el-form ref="form" :model="form"   status-icon label-width="100px">
                    ...
                    <el-form-item label="计费方式:">
                       <el-radio-group v-model="form.charge_mode">
                          <el-radio-button label="1">CPT</el-radio-button>
                          <el-radio-button label="2">CPM</el-radio-button>
                          <el-radio-button label="3">CPC</el-radio-button>
                        </el-radio-group>
                    </el-form-item>
                    <el-form-item label="单价:">
                      <el-input-number v-model="form.price" style="width:40%"></el-input-number>元
                    </el-form-item>
                    <el-form-item label="每日限额:" v-if="form.charge_mode == 2">
                        <el-input-number v-model="form.unitLimit" style="width:40%"></el-input-number>元
                    </el-form-item>
                    ...
                    <el-form-item label="投放类型:">
                      ...
                      <el-form-item label="推广链接:" v-if="form.put_type == 2">
                          <el-input v-model="form.name" style="width:77%"></el-input>
                      </el-form-item>
                    ...
                    <div class="border">
                      <el-form-item label="曝光上报地址:">
                          <div v-for="(address1,index_) in form.make_address1" :key="index_">
                            ...
                            <el-button type="primary" icon="el-icon-close" @click="delete_make(index_)" v-show="index_ !=0"></el-button>
                         </div>
                      </el-form-item>
                    </div>
               ...
               <el-form ref="form" :model="form"  status-icon label-width="100px">
                 <el-tag type="success">设置排期</el-tag>
                    <el-form-item label="订单时间:">
                        <el-input v-model="time_order" :disabled="true" style="width:60%"></el-input>
                    </el-form-item>
            ...
            <el-tab-pane label="定向设置" name="second_3">
              <el-form ref="form" :model="form"  status-icon label-width="100px">
