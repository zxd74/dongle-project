<template>
    <div class="box">
        ...
        <el-table :data="IdearData" border style="width: 100%" ref="multipleTable">
        ...
        <div class="border">订单投放分日数据:</div>
        <el-table :summary-method="getSummaries" show-summary :data="DetailTable" border style="width: 100%" ref="multipleTable">
  ...
  mounted() {
   ...
   methods: {
    ...
    IdearReport(index,row){
        this.$router.push({path:'/datareport/idearone', query:{entId:row.entId}})
      },
            //   导出table方法
    exportExcel () {
