...
import { quotaBookdetail } from "@/api/Api.js";
   ...
   methods: {
     getList() {
      let params = {
                ...
                level1s:this.$route.query.level1s,
                level2s:this.$route.query.level2s,
                level3s:this.$route.query.level3s,
                sDate:this.$route.query.sDate,
                eDate:this.$route.query.eDate,
                group:this.$route.query.group
        }
        quotaBookdetail(params).then(res=>{
              console.log(res)
              let data = res.data
