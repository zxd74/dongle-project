    ...
    <div class="box">
        <div class="block">
           <div class="header-select">
                 <template>
                      <el-tag size="medium">创意ID:</el-tag>
                      <el-input v-model="idea_ID"  class="handle-input mr10"></el-input>
                      <el-tag size="medium">创意:</el-tag>
                      <el-input v-model="idea_"  class="handle-input mr10"></el-input>
