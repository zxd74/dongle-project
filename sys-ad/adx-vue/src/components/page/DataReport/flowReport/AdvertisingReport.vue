    ...
    <div class="box">
        <div class="block">
           <div class="header-select">
                 <template>
                      <el-tag size="medium">流量源:</el-tag>
                      <el-select v-model="flow_sueers">
                                <el-option
                      ...
                      <el-tag size="medium">广告位:</el-tag>
                      <el-select v-model="AD_location">
                                <el-option
        ...
        <el-table :data="data" border style="width: 100%" ref="multipleTable">
                ...
                <el-table-column prop="date" label="请求量">
                </el-table-column>
                <el-table-column prop="date" label="展现量">
                </el-table-column>
                <el-table-column prop="date" label="点击量" >
                </el-table-column> 
                <el-table-column prop="date" label="展现率%">
                </el-table-column>
