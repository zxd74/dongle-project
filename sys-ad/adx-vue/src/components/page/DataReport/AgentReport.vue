<template>
    <div class="box">
        ...
        <el-tag size="medium">代理商数据:</el-tag>
        <el-table :data="tableCustom" border style="width: 100%" ref="multipleTable" id="table1">
        ...
        <el-tag size="medium">代理商分日数据:</el-tag>
        <el-table :data="tableDate" border style="width: 100%" ref="multipleTable" id="table2">
...
methods: {
        ...
        companyquotaByUser(params).then(res=>{
          let data = res.data;
            ...
            for(var item of data.data){
                ...
                CPC.push(item.clk > 0 ? (item.cost/item.clk/100000).toFixed(2) : 0); //CPC
            }
    ...
    exportExcel () {
            ...
            var wb1 = XLSX.utils.table_to_book(document.querySelector('#table2'))
            ...
            try {
              ...
              FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '代理商数据.xlsx')

            FileSaver.saveAs(new Blob([wbout1], { type: 'application/octet-stream' }), '代理商分日数据.xlsx')
