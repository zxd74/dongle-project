<template>
    <div class="box">
        ...
        <!-- <div class="border">订单数据:</div>
        <el-table :data="OrderData" border style="width: 100%" ref="multipleTable" id="table1">
                <el-table-column prop="name" label="订单ID" align="center">
                </el-table-column>
                <el-table-column prop="name" label="订单名称" align="center">
                </el-table-column>
                <el-table-column prop="name" label="展现量" align="center">
                </el-table-column> 
                <el-table-column prop="name" label="点击量" align="center">
                </el-table-column>
                <el-table-column prop="name" label="点击率" align="center">
                </el-table-column>
                <el-table-column prop="name" label="花费" align="center">
                </el-table-column>
                <el-table-column prop="name" label="CPM" align="center">
                </el-table-column>
                <el-table-column prop="name" label="CPC" align="center">
                </el-table-column>
                <el-table-column prop="name" label="激活数" align="center">
                </el-table-column>
                <el-table-column prop="name" label="CPA" align="center">
                </el-table-column>
                <el-table-column prop="name" label="CVR" align="center">
                </el-table-column>
        </el-table> -->
        <div class="border">订单投放列表:</div>
        <el-table :data="IdearList" border style="width: 100%" ref="multipleTable" id="table2">
                <el-table-column prop="putId" label="订单投放ID" align="center">
                </el-table-column>
                ...
                <el-table-column align="center" width="110">
                    <template slot-scope="scope" align="center">
                        <el-button size="small" type="success" @click="IdearReport(scope.$index, scope.row)">订单投放报告</el-button>
                    </template>
                </el-table-column>
        </el-table>
   ...
   methods: {
      ...
      search(){
        ...
        var echartsDate  = [];
          ...
          quotaOrderlistByDay(params).then(res=>{
