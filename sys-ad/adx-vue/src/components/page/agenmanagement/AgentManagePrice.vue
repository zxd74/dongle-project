    ...
    <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <!-- <el-button type="primary" icon="search" @click="create">新建底价</el-button> -->
            </div>
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable">
                ...
                <el-table-column prop="payTypeName" label="付费类型" width="" align="center">
                </el-table-column>
                ...
                <!-- <el-table-column label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button size="mini" type="success" @click="syncPrice(scope.$index, scope.row)">同步价格</el-button>
                        <el-button size="mini" type="danger" @click="syncProfit(scope.$index, scope.row)">同步利润率</el-button>
                    </template>
                </el-table-column> -->
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取 table
            getList() {
                let params = {aid:this.id, sysFlag: 0, cp: this.cur_page, ps: this.ps}
                PriceList(params).then(res => {
                  let data = res.data;
                    this.tableData = data.data.data
                    this.total = data.data.totalItemNum;
