...
public class MurmurHash {
	...
	public static int hash32(String str, int seed) {
		ByteBuffer key = ByteBuffer.wrap(str.getBytes(Charset.forName("UTF-8")));
		return hash32(key, 0, key.limit(), seed);
	}

	public static long hash2_64(String str, long seed) {
		ByteBuffer key = ByteBuffer.wrap(str.getBytes(Charset.forName("UTF-8")));
		return hash2_64(key, 0, key.limit(), seed);
	}
	...
	public static void main(String[] args) {
		int value = Math.abs(MurmurHash.hash32("201609256108", 1418));
