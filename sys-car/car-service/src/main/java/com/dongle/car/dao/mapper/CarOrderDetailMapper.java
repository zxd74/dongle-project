...
public interface CarOrderDetailMapper {
    ...
    int batchInsert(@Param("list") List<CarOrderDetail> list);

    int batchInsertSelective(@Param("list") List<CarOrderDetail> list, @Param("selective") CarOrderDetail.Column ... selective);
}